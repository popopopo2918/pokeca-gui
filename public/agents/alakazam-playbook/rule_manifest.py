...
_FLOW = {
    ...
    "FLOW-ATTACK-ENERGY": "超エネルギーを確保してフーディンへ付ける",
    "FLOW-ATTACK-HAND": "KO可能まで手札を増やし、可能になればハンドパワーを使う",
...
_PLAYBOOK = {
    ...
    "PLAYBOOK-T3-KADABRA": "2ターン目失敗後はユンゲラー経由で3ターン目攻撃する",
    "PLAYBOOK-SACRED-ASH": "せいなるはいでポケモンを再利用する",
    "PLAYBOOK-LANAS-AID": "スイレンのお世話でルールなしポケモンと基本超を戻す",
    "PLAYBOOK-ENHANCED-HAMMER": "改造ハンマーは相手の特殊エネルギーだけを対象にする",
    "PLAYBOOK-BOSS": "ボスの指令は倒せるベンチを呼ぶ目的で使う",
