...
KO_CHAIN_SELECT_ONE_REASON_CODE = 1303
KO_CHAIN_SELECT_TWO_REASON_CODE = 1304
...
class ScalarFeature(IntEnum):
    ...
    ACTIVE_KO_REACHABILITY = 108
    ACTIVE_KO_NEXT_STEP = 109
    ACTIVE_KO_FIRST_HIT = 110
    ACTIVE_KO_HITS_REMAINING = 111
    ACTIVE_KO_GOAL_BENCH = 112
    ACTIVE_KO_ROUTE_DAMAGE = 113
    SEARCH_ECONOMY_CLASS = 114
    SEARCH_ECONOMY_NEXT_STEP = 115
    SEARCH_ECONOMY_RESERVED_EXACT = 116
    KO_CHAIN_CLASS = 117
    KO_CHAIN_NEXT_STEP = 118
    KO_CHAIN_GOAL_BENCH = 119
    KO_CHAIN_GUARANTEED_PRIZES = 120
    KO_CHAIN_SECOND_HIT_DAMAGE = 121
    KO_CHAIN_WORST_REMAINING_HP = 122
    KO_CHAIN_RESOURCES_COVER_GAME = 123
    KO_CHAIN_BENCH_ADDITIONS = 124
